...
//creates the cubes by calling createcubes, then assigns the correct points to each cube by using pt2cube
void AssignCubes(double r,double* a,double* b,pt* pts,int numpts,cube* cubes,
                 int* cubePtsArray,int maxNbrs,int dim){
