...
t_cal=linesearch(points, newpoints, numpts, currEnergy, theDir, t0, radius, cornera, cornerb, cubes, numCubes, neighborArray,  maxNbrs, s, neighborhood, nbhds, writeTo, trinaryList, cubeNbhd, testIndex, cubePtsArray, dim, inner, updateMethod);

currEnergy=gradMethod(newpoints, newGrad, s, radius, cornera, cornerb, numpts, cubes, numCubes, nbhds, neighborArray, neighborhood, maxNbrs, trinaryList, cubeNbhd, testIndex,cubePtsArray,dim,inner);
...
t_cal=linesearch(points, newpoints, numpts, en0, theGrad, t0, radius, cornera, cornerb, cubes, numCubes, neighborArray,  maxNbrs, s, neighborhood, nbhds, writeTo, trinaryList, cubeNbhd, testIndex, cubePtsArray, dim, inner, updateMethod);
